...
# Google "python 3 csv" for references and use your Google-fu for
# other examples.
#
...
# should not change the results of what the `cityreader_stretch`
# function returns.
#
# Example I/O:
#
...
def cityreader_stretch(lat1, lon1, lat2, lon2, cities=[]):
    ...
    for city in cities:
        if min_lat <= city.lat <= max_lat and \
